...
const products = [
  {
    ...
    description: 'Immerse yourself in the serene beauty of the Coral and Arctic design with this high-quality mouse pad. Ideal for any workspace, it combines functionality with stunning visuals.',
    price: '€33.67',
  ...
  },
  {
    ...
    description: 'Bring serenity to your home with this beautiful clock.',
    price: '€31.52',
  ...
  },
  {
    ...
    description: 'Embrace modern elegance with the Striking Waves iPhone Wallet, featuring a dynamic pattern of flowing lines in black, yellow, and white. Durable and stylish, this wallet’s high-quality material and secure elastic band make it a must-have accessory for any fashion-conscious individual.',
    price: '€30.22',
  ...
  },
  {
    ...
    description: 'Travel in style with the ChocoRose Elegance duffle bag. This elegant travel bag features a refined design with rich chocolate and rose tones, perfect for weekend getaways or daily use. Durable and spacious, it combines functionality with fashion.',
    price: '€53.98',
  ...
  },
  {
    ...
    description: 'Transform your bathroom with the Vibrant Swirls Bathmat, featuring a stunning design of dynamic swirls in black, yellow, and white. Made from soft, high-quality materials, this bathmat adds a touch of modern elegance while providing comfort and durability, making it an essential addition to any stylish home.',
    price: '€18.79',
  ...
  },
  {
    ...
    description: 'A clock that brings the calm of nature into your home.',
    price: '€31.52',
  ...
  },
  {
    ...
    description: 'Dress your pet in the vibrant and cool tones of the Coral and Arctic design. This stylish and comfortable pet bandana is perfect for adding a touch of personality to your furry friend.',
    price: '€11.53',
